...
project_path = "/home/user/Desktop/python-p4-chatterbox-lab"
...
class TestApp:
    ...
    with app.app_context():
        m = Message.query.filter(
            (Message.body == "Hello ") & (Message.username == "Liza")
        )
    ...
    def test_deletes_message_from_database(self):
        ...
        with app.app_context():
            ...
            app.test_client().delete("/messages/{}".format(hello_from_liza.id))
